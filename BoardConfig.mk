...
#BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board Ulefone_T1
...
#TARGET_PREBUILT_BOOTIMG := $(DEVICE_PATH)/prebuilts/boot.img
...
ADDITIONAL_DEFAULT_PROPERTIES := $(shell cat $(DEVICE_PATH)/sprp.lst)
...
ADDITIONAL_BUILD_PROPERTIES := \
  ...
  ro.incoming_ledcolor=Red \
  ro.install.location=1 \
  ro.install.nonmarket.switch=no \
  ro.kernel.zio=38,108,105,16 \
  ro.keyboard.vibrate.value=60 \
  ...
  ro.unread_notifi_ledcolor=Blue \
